...
//               items: [
//                 TabItem(
//                   icon: AssetImageViewCustomized(imageUrl: iconProfile,),
//                   title: 'Home',
//                   isIconBlend: false,
//                   activeIcon: AssetImageViewCustomized(
//                     imageUrl: iconHomePage,
//                   ),
//                 ),
//                 TabItem(
//                   icon: CircleAvatar(
...
//                       child: AssetImageViewCustomized(imageUrl: iconSelectedCamera,imageHeight: height_80,imageFit: BoxFit.fitHeight,)),
//                   title: 'Favorite',
//                 ),
//                 TabItem(
//                   icon: Icons.settings,
